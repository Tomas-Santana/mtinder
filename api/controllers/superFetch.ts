...
interface SuperFetchMultiPartParams<Request, Response, Route extends ApiRoute = ApiRoute, QueryParams extends undefined | Record<string, any> = undefined> {
...
export async function suferFetchMultipart<Request, Response, Route extends ApiRoute = ApiRoute, QueryParams extends Record<string, any> | undefined = undefined>({
    options,
    route,
    routeParams,
    queryParams,
    responseSchema,
    payload,
}: SuperFetchMultiPartParams<Request, Response, Route, QueryParams>) {
    if (routeParams === undefined) {
        routeParams = [] as ApiRouteParams<Route>;
    }
